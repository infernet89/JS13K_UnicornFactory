...
const U_AIM = 0, U_SPD = 1, U_CAL = 2, U_SAW = 3, U_MAG = 4, U_WRD = 5, U_OVR = 6, U_RATE = 7, U_STK = 8, U_AUT = 9, U_APP = 10;
const UP = [
  ['Aim Glint', 'horn flashes when your ring lines up', [5]],
  ['Fleet Hooves', 'gallop @% faster across the factory floor', [12, 45, 140]],
...
const UV = [0, [0, 50, 108, 183], [42, 55, 65, 75, 99.99], 0, 0, ['', 'at the last moment', 'well ahead', 'half a screen ahead'], [0, 25, 55, 90], [0, 30, 65, 110], [0, 3, 6, 9], 0, [0, 1, 2, 3, 4, 5, 6]];
